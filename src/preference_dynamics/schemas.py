...
class ModelConfig(BaseModel):
    ...
    model_type: Literal["cnn1d", "lstm", "pinn", "feature_based", "optimization"] = Field(
...
#     hidden_dim: int = Field(default=128, ge=32, description="LSTM hidden dimension")

#     num_layers: int = Field(default=2, ge=1, le=5, description="Number of LSTM layers")

#     dropout: float = Field(default=0.2, ge=0.0, le=0.5, description="Dropout rate")

#     bidirectional: bool = Field(default=False, description="Whether to use bidirectional LSTM")
