"""
1D CNN model for parameter prediction from time series.
"""
...
from preference_dynamics.models.schemas import CNN1DConfig


class CNN1DPredictor(PredictorModel):
    """
    1d CNN model for predicting parameters from time series.
    ...
    def __init__(self, config: CNN1DConfig) -> None:
